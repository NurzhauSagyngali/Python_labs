...
pygame.mixer.music.load(r'resources/background.wav')
...
background = pygame.image.load(r"resources\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"resources\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"resources\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"resources\coin.png")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound(r'resources\crash.wav').play()
        time.sleep(1)
    ...
    if collided_coin:
        pygame.mixer.Sound(r'resources\coin.mp3').play()
